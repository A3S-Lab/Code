...
| `SDK-R1` | Next | Expose typed retrieval configuration, status, semantic/hybrid request and result DTOs, and lifecycle parity in Node, Python, and Go without duplicating ranking behavior |
