...
#[pyclass(name = "WorkspaceLexicalEngineOption", eq, eq_int)]
...
impl From<PyWorkspaceLexicalEngineOption> for a3s_code_core::WorkspaceLexicalEngine {
...
pub(super) struct PyWorkspaceRetrievalOptions {
    ...
    #[pyo3(get, set)]
    pub(super) lexical_engine: PyWorkspaceLexicalEngineOption,
    #[pyo3(get, set)]
...
impl PyWorkspaceRetrievalOptions {
    #[new]
    #[pyo3(signature = (provider, reranker=None, chunking_strategy=None, lexical_engine=None))]
    fn new(
        py: Python<'_>,
        ...
        lexical_engine: Option<PyWorkspaceLexicalEngineOption>,
    ) -> PyResult<Self> {
        Ok(Self {
    ...
    fn __repr__(&self) -> String {
        format!(
            "WorkspaceRetrievalOptions(max_records={}, max_bytes={}, shutdown_timeout_ms={}, lexical_engine={:?}, reranker={}, chunking_strategy={:?})",
            self.max_records,
            self.max_bytes,
...
pub(super) fn retrieval_options_to_core(
    ...
    retrieval = retrieval.with_lexical_engine(options.lexical_engine.into());
