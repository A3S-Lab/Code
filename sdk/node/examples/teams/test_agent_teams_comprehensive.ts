...
class AgentTeamsComprehensiveTest {
  ...
  testTaskBoardPrimitives(): void {
    ...
    // QA reviews
    const inReview: TeamTask[] = board.byStatus(TeamTaskStatus.InReview);
  ...
  async testCodeQualityAudit(): Promise<void> {
    ...
    team.addMember('tech-lead', TeamRole.Lead);
    team.addMember('auditor', TeamRole.Worker);
    team.addMember('senior-dev', TeamRole.Reviewer);
  ...
  async testParallelWorkers(): Promise<void> {
    ...
    team.addMember('architect', TeamRole.Lead);
    team.addMember('backend-dev', TeamRole.Worker);
    team.addMember('frontend-dev', TeamRole.Worker);
    team.addMember('code-reviewer', TeamRole.Reviewer);
    ...
    const reviewTasks: TeamTask[] = board.byStatus(TeamTaskStatus.InReview);
  ...
  async testManualPostThenRun(): Promise<void> {
    ...
    const done: TeamTask[] = finalBoard.byStatus(TeamTaskStatus.Done);
    const inReview: TeamTask[] = finalBoard.byStatus(TeamTaskStatus.InReview);
