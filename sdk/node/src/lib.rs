...
/// One product capability available through the official SDK surface.
///
/// The inventory is generated by Rust Core and projected without a second
/// language-specific list, so Node applications can feature-detect optional
/// integrations (such as Moli or S3) without relying on package internals.
#[napi(object)]
#[derive(Clone)]
...
/// Return the stable schema identifier for [`sdk_capabilities`].
#[napi(js_name = "sdkCapabilitiesSchema")]
pub fn sdk_capabilities_schema() -> String {
