...
export interface MiddlewareResultObject {
  resultType: string
  reason?: string
}
...
export declare class MiddlewarePipeline {
  constructor()
  useMiddleware(callback: (ctx: MiddlewareContext) => MiddlewareResultObject): void
  execute(ctx: MiddlewareContext): Promise<MiddlewareContext>
  len(): number
}
/** Logging middleware */
