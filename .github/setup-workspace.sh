...
sed -i.bak \
  ...
  -e 's|a3s-search = { version = "1.4.1", path = "../../search", default-features = false, features = \["lightpanda"\] }|a3s-search = { version = "=1.4.1", default-features = false, features = ["lightpanda"] }|' \
