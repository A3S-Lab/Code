...
pub use search::{
    BrowserBackend, DocumentCacheConfig, DocumentParserConfig, HeadlessConfig, SearchCascadeTier,
...
pub struct AutoDelegationConfig {
    ...
    /// Allow the model-visible `task` tool (including multi-item fan-out).
    ///
