...
summarizes older history without splitting tool calls from results, and re-arms
after success so a long session can compact repeatedly. The summary is treated
as untrusted transcript data, not as a new source of executable instructions.
