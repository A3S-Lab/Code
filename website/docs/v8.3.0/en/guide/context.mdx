...
session-local zvec-rust FTS collection for lexical ranking; its native handles
...
zvec-rust owns lexical FTS/BM25 postings in product builds; a minimal build can
