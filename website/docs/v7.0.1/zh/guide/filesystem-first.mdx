...
| `.a3s/agents/`            | 存放 worker/subagent 定义                    | 父 agent 需要 `task` 或自动委派。                          |
...
1. [约定大于配置](/guide/convention-over-configuration)
2. [AGENTS.md](/guide/agents-md)
3. [instructions.md](/guide/filesystem-instructions)
4. [agent.acl](/guide/filesystem-config)
5. [Agent 目录](/guide/agent-dir)
6. [agents/ 角色目录](/guide/filesystem-agents)
7. [skills/ 技能目录](/guide/filesystem-skills)
8. [tools/ 工具目录](/guide/filesystem-tools)
9. [schedules/ 调度目录](/guide/filesystem-schedules)
