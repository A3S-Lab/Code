...
(Allow / no-op). Python callback errors fall back to Allow. Go callback errors,
timeouts, and malformed decisions fail closed as Deny.
...
None` and re-create the session (Python) to clear. Call
