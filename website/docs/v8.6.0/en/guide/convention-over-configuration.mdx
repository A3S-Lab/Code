...
| --------------------- | ------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Agent as a directory  | [Agent Directory](/guide/agent-dir)                                      | `instructions.md`, `agent.acl`, `skills/`, `tools/`, and `schedules/` synthesize a runnable agent.                                                       |
...
1. [Filesystem-First](/guide/filesystem-first)
2. [Agent Directory](/guide/agent-dir)
3. [agents/ Role Directory](/guide/filesystem-agents)
4. [tools/ Tool Directory](/guide/filesystem-tools)
5. [schedules/ Schedule Directory](/guide/filesystem-schedules)
6. [Tasks](/guide/tasks)
7. [Teams](/guide/teams)
