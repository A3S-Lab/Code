...
搜索使用结构门控级联：Core 默认 feature 中的 Chrome/Chromium 层、HTTP/RSS 引擎，
...
v8.0.3 的 Python 包通过每个平台一个 `cp310-abi3` Wheel 支持 CPython 3.10 至
3.14。Intel Mac 使用 `macosx_12_0_x86_64` Wheel，最低需要 macOS 12。请参阅
[Python Wheel 平台](/api/#python-wheel-平台-v803)了解 Bootstrap 流程，以及
