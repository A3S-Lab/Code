...
## Python wheel platforms (v8.0.3)

`a3s-code` on PyPI is a small pure-Python bootstrap. On first import it
downloads the matching native wheel from the v8.0.3 GitHub Release and checks
...
| Host                | Wheel platform tag      | Baseline    |
| ------------------- | ----------------------- | ----------- |
| Apple Silicon macOS | `macosx_11_0_arm64`     | macOS 11+   |
| Intel macOS         | `macosx_12_0_x86_64`    | macOS 12+   |
